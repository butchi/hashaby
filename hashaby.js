...
(function () {
  ...
  function jumpTo(target) {
    var top = (0, _jquery2.default)(target).offset().top;

    (0, _jquery2.default)('body,html').scrollTop(top);
  }
  ...
  var Hashaby = function () {
    function Hashaby() {
      ...
      (0, _jquery2.default)(function () {
        (0, _jquery2.default)(document).on('click', 'a[href]', function (evt) {
      ...
      (0, _jquery2.default)(window).on('load hashchange', function (evt) {
